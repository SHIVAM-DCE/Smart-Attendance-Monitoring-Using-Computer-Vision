...
class Student:
    def __init__(self,root):
        ...
        current_course_frame.place(x=10,y=150,width=730,height=150)
        ...
        course_lebel.grid(row=0,column=2,padx=10)
        ...
        sem_lebel.grid(row=1,column=2,padx=10)
        ...
        class_student_frame.place(x=-1,y=270,width=729,height=295)
        ...
        # Student name
        studentName_lebel=Label(class_student_frame,text="Student Name:",font=("times new roman",12,"bold"),bg="white")
        studentName_lebel.grid(row=0,column=2,padx=10,pady=5,sticky=W)

        studentName_entry=ttk.Entry(class_student_frame,textvariable=self.var_std_name,width=20,font=("times new roman",12,"bold"))
        studentName_entry.grid(row=0,column=3,padx=10,pady=5,sticky=W)

        # Class Division
        class_div_lebel=Label(class_student_frame,text="Class Division:",font=("times new roman",12,"bold"),bg="white")
        class_div_lebel.grid(row=1,column=0,padx=10,pady=5,sticky=W)
        ...
        # Roll number
        roll_no_lebel=Label(class_student_frame,text="Roll Number:",font=("times new roman",12,"bold"),bg="white")
        roll_no_lebel.grid(row=1,column=2,padx=10,pady=5,sticky=W)
        ...
        # Date of Birth
        dob_lebel=Label(class_student_frame,text="Date of Birth:",font=("times new roman",12,"bold"),bg="white")
        ...
        # Phone number
        phone_lebel=Label(class_student_frame,text="Phone Number:",font=("times new roman",12,"bold"),bg="white")
        phone_lebel.grid(row=3,column=2,padx=10,pady=5,sticky=W)
        ...
        # Teacher name
        teacher_lebel=Label(class_student_frame,text="Teacher Name:",font=("times new roman",12,"bold"),bg="white")
        teacher_lebel.grid(row=4,column=2,padx=10,pady=5,sticky=W)
        ...
        btn_frame.place(x=0,y=205,width=727,height=30)
...
# =============================reset button=========================
        ...
        # Button frame for photo samples
        btn_frame_1=Frame(class_student_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame_1.place(x=0,y=237,width=727,height=30)

        # Configure columns for photo sample buttons
        btn_frame_1.columnconfigure(0, weight=1)
        btn_frame_1.columnconfigure(1, weight=1)

        take_photo_sample=Button(btn_frame_1,command=self.generate_dataset,text="Take Photo Sample",font=("times new roman",12,"bold"),bg="blue",fg="white")
        take_photo_sample.grid(row=0,column=0,columnspan=1,sticky="nsew", padx=2, pady=2)

        update_photo_sample=Button(btn_frame_1,command=self.update_data,text="Update Photo Sample",font=("times new roman",12,"bold"),bg="blue",fg="white")
        update_photo_sample.grid(row=0,column=1,columnspan=1,sticky="nsew", padx=2, pady=2)
        ...
        Search_frame.place(x=0,y=135,width=718,height=70)

        #search label
        search_lebel=Label(Search_frame,text="Search By:",font=("times new roman",12,"bold"),bg="red",fg="white")
        ...
        search_btn.grid(row=0,column=3,sticky="nsew", padx=2, pady=2)

        showAll_btn=Button(Search_frame,text="Show All",width=14,font=("times new roman",12,"bold"),bg="blue",fg="white")
        showAll_btn.grid(row=0,column=4,sticky="nsew", padx=2, pady=2) 
...
# =========================Load predefined data on face frontals from face frontal and convert it into numpy array and do some pre processing=========================
                    ...
                    if img_id==0:
                        messagebox.showerror("Error","No face captured. Please try again",parent=self.root)
                        return
                    
                    # Auto-save student record to database with photo sample status
                    conn=mysql.connector.connect(host="localhost",username="root",password="Shivam@123",database="face_recognizer")
                    my_cursor=conn.cursor()
                    ...
                    if existing_record is None:
                        ...
                        # Update existing record with photo sample status
                        my_cursor.execute(
                            "UPDATE `student` SET `Dep`=%s, `course`=%s, `Year`=%s, `Semester`=%s, `Name`=%s, `Division`=%s, `Roll`=%s, `Gender`=%s, `Dob`=%s, `Email`=%s, `Phone`=%s, `Address`=%s, `Teacher`=%s, `PhotoSample`=%s WHERE `Student_id`=%s",
                            (
                                self.var_dep.get(),
                    ...
                    conn.close()
                    messagebox.showinfo("Result",f"Photo sample captured: {img_id} images. Student record saved automatically!",parent=self.root)
                except Exception as es:
                    messagebox.showerror("Error",f"Due To:{str(es)}",parent=self.root)
